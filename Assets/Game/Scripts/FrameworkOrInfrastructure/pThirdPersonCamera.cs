...
public class pThirdPersonCamera : MonoBehaviour
{
    ...
    private float deltaTime = 0.0167f;

    public System.Action<float, float> OnMouseXYChanged;
    ...
    private void GetNetworkDeltaTime()
    {
        deltaTime = NetworkRoomManager.instance.GetRunnerDeltaTime();
    }

    public virtual void FixedUpdateNetworkTick()
    {
    ...
    public void RotateCamera(float x, float y)
    {
        ...
        OnMouseXYChanged?.Invoke(mouseX, mouseY);
    }
    ...
    protected virtual void CameraMovement()
    {
        ...
        distance = Mathf.Lerp(distance, defaultDistance, smoothFollow * deltaTime);
        cullingDistance = Mathf.Lerp(cullingDistance, distance, deltaTime);
        ...
        targetLookAt.rotation = Quaternion.Slerp(targetLookAt.rotation, newRot, smoothCameraRotation * deltaTime);
